...
This document defines the `did:ckb` Document format specific for Nostr protocol. Since CKB DID is generic, it can be used in different social networks. By default, the DID Document format is compatible with AT Protocol. This document defines the specific key value rules under the CKB DID Document format to support Nostr specific features.
